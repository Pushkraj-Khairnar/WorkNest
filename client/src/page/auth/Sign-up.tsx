...
import RocketIllustration from "@/assets/undraw_global-team.svg?url";
    ...
    <div className="min-h-screen flex flex-col md:flex-row relative">
      ...
      <div className="hidden md:flex flex-col justify-center items-center w-1/2 bg-[#4f8cff] text-white relative overflow-hidden">
        <div className="flex flex-col items-center z-10 px-8">
          <h2 className="text-3xl font-bold mb-2 mt-8 text-center">Welcome!</h2>
          <p className="mb-6 text-center text-base font-light max-w-xs">Create your workspace, invite your team, and launch your next big project with WorkNest!</p>
          <button
            type="button"
            onClick={() => navigate("/")}
        ...
        <img src={RocketIllustration} alt="Team Illustration" className="w-2/3 max-w-md mt-12 mb-4 z-0" />
      </div>
      {/* Right Side */}
      <div className="flex flex-1 flex-col justify-center items-center bg-white px-4 py-12 min-h-screen">
        <div className="w-full max-w-md flex flex-col items-center animate-fade-in">
          <h1 className="mb-8 text-3xl font-extrabold font-sans text-black tracking-tight text-center">Sign up</h1>
