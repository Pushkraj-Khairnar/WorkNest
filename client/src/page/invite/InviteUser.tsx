...
const InviteUser = () => {
  ...
  const { mutate, isPending: isLoading } = useMutation({
    mutationFn: (inviteCode: string) => invitedUserJoinWorkspaceMutationFn(inviteCode),
  });
          ...
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-xl">
                Hey there! You're invited to join a WorkNest Workspace!
              </CardTitle>
              <CardDescription>
                Looks like you need to be logged into your WorkNest account to
                join this Workspace.
              </CardDescription>
            </CardHeader>
            <CardContent>
